...
export const content = {
  pl: {
    ...
    hero: {
      ...
      lead: 'Studiuję informatykę i jednocześnie rozwijam się jako full stack developer, głównie Next.js, TypeScript, Supabase i trochę AI-assisted development w codziennej pracy. Nie mam jeszcze komercyjnego doświadczenia w tej roli, ale zbudowałem kilka własnych projektów od zera, co dało mi dobre czucie całego procesu: od projektu bazy danych, przez API, aż po wdrożenie. Interesuję się automatyzacją i narzędziami, które naprawdę ułatwiają życie.',
  ...
  en: {
    ...
    hero: {
      ...
      name: 'Piotr Ponikiewski',
      handle: 'Full-stack Developer',
      lead: 'I am studying computer science while developing as a full-stack developer, mainly Next.js, TypeScript, Supabase and some AI-assisted development in day-to-day work. I do not have commercial experience in this role yet, but I have built several projects from scratch, which gave me a good feel for the whole process: from database design, through the API, to deployment. I am interested in automation and tools that genuinely make life easier.',
