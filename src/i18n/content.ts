...
export const content = {
  pl: {
    ...
    hero: {
      status: 'Otwarty na wspolprace',
      eyebrow: 'Piotr Ponikiewski / Full-stack Developer',
      title: 'Projektuje i buduje aplikacje od architektury po release.',
      lead:
        'Tworze produkty webowe, desktopowe i AI. Interesuje mnie pelna droga: model danych, interfejs, synchronizacja, wdrozenie i realne uzycie.',
      primaryCta: 'Zobacz projekty',
      secondaryCta: 'Napisz do mnie',
      panelTitle: 'Product cockpit',
      panelItems: [
        ['Projects', '3'],
        ['Released', '1'],
        ['In progress', '1'],
      ...
      activity: ['offline sync ready', 'release pipeline active', 'ai tools in progress'],
    },
    projectsIntro: {
  ...
  en: {
    ...
    hero: {
      ...
      eyebrow: 'Piotr Ponikiewski / Full-stack Developer',
      title: 'I design and build applications from architecture to release.',
      lead:
        'I build web, desktop and AI products. I care about the full path: data model, interface, synchronization, deployment and real usage.',
